...
4. Външни източници
github repo: https://github.com/Tonari239/VirtualLibrary
...
•	void free()- изтрива динамичната памет, използва се в оператор= и деструктор
•	ool operator==(const User& other) const- проверява дали два потребитела са едни и същи като сравнява потребителското им име и паролата
